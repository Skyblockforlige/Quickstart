...
public class auton extends OpMode {
    ...
    public void buildPaths() {
        ...
        //move_back = new Path(new BezierLine(new Point(subpose), new Point(finalback)));
        //move_back.setLinearHeadingInterpolation(subpose.getHeading(), finalback.getHeading());

        // block = new Path(new BezierLine(new Point(subpose), new Point(subcontrol)));
        // block.setLinearHeadingInterpolation(subpose.getHeading(), subcontrol.getHeading());


        //seconds_block = follower.pathBuilder()
                //.addPath(new BezierLine(new Point(pos1), new Point(pos2_control)))
                //.addPath(new BezierCurve(new Point(pos2_control), new Point(pos2),new Point(pos2_final)))
